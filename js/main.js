...
//Назначаем глобальную переменную url и назначаем ссылку запроса по умолчанию
window.url = "https://api.thecatapi.com/v1/images/search?limit=20";
...
getPhotos(url, butt, api_cat_key);
